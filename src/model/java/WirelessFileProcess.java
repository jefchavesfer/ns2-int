...
public class WirelessFileProcess {
    ...
    public void processFile() {
        while (this.i < this.numberOfScripts) {
            String filename = this.fileDiscriminator + this.i + ".tr";
                ...
                if (key.contains("s")) {
                    if (first) {
                        ...
                        if (!droppedData.containsKey(packetFlow.getKey())) {
                            ...
                            System.out.println("packet " + packetFlow.getKey()
                                    + " shown suspicious transmission failure");
                        }
                        endFlow = "dropped";
